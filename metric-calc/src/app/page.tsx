    ...
    <div className="container mx-auto px-4 py-8">
      <section className="py-12 md:py-20">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h1 className="mb-4">Unit Conversion Made Easy</h1>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link 
              href="/volume-mass" 
              className="bg-primary hover:bg-primary-700 text-white font-medium py-2 px-6 rounded-lg transition-colors"
            >
              Get Started
            </Link>
            <Link 
      ...
      <section id="converters" className="py-12">
        <h2 className="text-center mb-12">Choose a Converter</h2>
      ...
      <section className="py-12 bg-secondary/30 rounded-xl mt-12 p-8">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-center mb-8">Why Choose MetricCalc?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Instant conversions with high precision results</p>
            </div>
            <div className="text-center">
              <div className="bg-primary/10 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-muted-foreground">No ads, no tracking, and no data collection</p>
            </div>
            <div className="text-center">
              <div className="bg-primary/10 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-muted-foreground">All the unit converters you need in one place</p>
            </div>
          </div>
        </div>
      </section>
